...
function PainelPage() {
  ...
  return (
    <main className={`h-screen overflow-hidden text-[#2D2823] lg:bg-[#faf8f4] ${tab === "dashboard" ? "bg-[linear-gradient(to_top,#ba9051_0%,#ffffff_15%,#ffffff_100%)]" : "bg-[#faf8f4]"}`}>
      {patientToast && (
