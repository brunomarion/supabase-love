          ...
          <div className="min-w-0">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex shrink-0 flex-col items-end gap-1.5 lg:hidden">
                <Button onClick={onAdd} className="h-[50px] w-[calc(100%+0px)] rounded-xl bg-[#BA9051] px-3 text-[14px] font-semibold text-white shadow-[0_6px_18px_rgba(186,144,81,0.18)] hover:bg-[#A97A3C]"><Plus className="size-3.5" />+Novo Paciente</Button>
        ...
        <div className="flex min-w-0 items-center justify-between gap-4 lg:block">
          <div className="min-w-0">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex shrink-0 flex-col items-end gap-1.5 lg:hidden">
                <Button onClick={onAdd} className="h-[50px] w-full rounded-xl bg-[#BA9051] px-3 text-[14px] font-semibold text-white shadow-[0_6px_18px_rgba(186,144,81,0.18)] hover:bg-[#A97A3C]"><Plus className="size-3.5" />+ Cadastrar Exercício</Button>
              </div>
            </div>
          </div>
        </div>
