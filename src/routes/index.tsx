...
function LoginPage() {
  ...
  return (
    <main className="fixed inset-0 h-[100dvh] w-full overflow-hidden bg-[linear-gradient(to_top,#f7efe5_0%,#ffffff_100%)] text-[#25211d] lg:static lg:grid lg:grid-cols-2 lg:min-h-screen lg:h-auto lg:bg-white">
